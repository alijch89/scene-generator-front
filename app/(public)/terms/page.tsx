...
const SECTIONS = [
  ...
  },
  {
    ...
    title: 'پرداخت',
    body: 'پرداخت برای هر قصه جداگانه و بر اساس طول ویدیوی انتخابی انجام می‌شود؛ اشتراک، تمدید خودکار و بستهٔ اعتباری در کار نیست، پس چیزی برای لغو کردن هم وجود ندارد. قصه‌هایی که پرداخت شده‌اند در کتابخانهٔ شما می‌مانند. اگر ساخت قصه‌ای با خطا متوقف شود، ساخت دوبارهٔ همان قصه پرداخت تازه‌ای ندارد.',
  },
];
